...
import org.drools.test.parentkjar.ParentKJarMeasurement;
...
public class RuleTest {
    ...
    public void test() {
        ...
        KieBase kieBase = kContainer.getKieBase("parentKJarKieBase");
        ...
        ParentKJarMeasurement mRed= new ParentKJarMeasurement("color", "red");
        session.insert(mRed);
        session.fireAllRules();

        ParentKJarMeasurement mGreen= new ParentKJarMeasurement("color", "green");
        session.insert(mGreen);
        session.fireAllRules();

        ParentKJarMeasurement mBlue= new ParentKJarMeasurement("color", "blue");
